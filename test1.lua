--==================================================
-- AUTO FARM / TELEPORT ABOVE MOB
-- ROBLOX STUDIO - FULL FIXED VERSION
--==================================================
...
local Settings = {
    ...
    -- Tìm quái tối đa 500 studs
    MaxTeleportDistance = 500,

    -- Đứng trên đầu quái
    HeightAboveMob = 8,

    -- Bật teleport trực tiếp
    InstantTeleport = true,

    -- Tốc độ nếu tắt InstantTeleport
    FlySpeed = 180,
...
local function TeleportAboveMob(Mob)
    ...
    -- Dịch chuyển thẳng tới trên đầu
    Root.CFrame =
        CFrame.lookAt(
            TargetPosition,
            MobRoot.Position
...
local function HoldAboveMob(Mob)
...
SubTitle.Text =
    "Teleport • Hold Above Mob • Attack"
...
MeleeButton.MouseButton1Click:Connect(
    function()
...
SwordButton.MouseButton1Click:Connect(
    function()
...
RangeValue.MouseButton1Click:Connect(
    function()
...
HeightValue.MouseButton1Click:Connect(
    function()
...
AttackValue.MouseButton1Click:Connect(
    function()
...
SpeedValue.MouseButton1Click:Connect(
    function()
